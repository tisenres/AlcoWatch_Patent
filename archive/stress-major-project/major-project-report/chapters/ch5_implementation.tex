...
described in Chapter~\ref{ch:methodology}. It is organized top-down:
...
The project is organized into four top-level directories that
correspond to the four major build artifacts (Python wheel, Wear~OS
...
\texttt{stress\_model.tflite} artifact is the only file that crosses
...
with the default encoding because they were serialized under Python
...
quantiles are computed once on the subject's stress-labeled samples
