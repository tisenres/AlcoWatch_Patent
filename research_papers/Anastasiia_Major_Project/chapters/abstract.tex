...
over 93\% and a macro F1-score above 0.91. The quantised TensorFlow Lite model occupies
under 80~KB, making it suitable for deployment on resource-constrained wearable hardware.
